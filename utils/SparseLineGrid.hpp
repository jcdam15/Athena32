...
#ifndef ATHENA_UTILS_SPARSE_LINE_GRID_H
#define ATHENA_UTILS_SPARSE_LINE_GRID_H
...
template<class ElemT, class Locator>
void SparseLineGrid<ElemT, Locator>::insert(const Elem &elem)
{
    ...
    std::function<bool(GridMap *, const GridPoint)> process_cell_func_ =
        [&elem](GridMap *m_grid, const GridPoint grid_loc)
    {
...
#endif // ATHENA_UTILS_SPARSE_LINE_GRID_H
