...
#ifndef ATHENA_SKELETAL_TRAPEZOIDATION_JOINT_H
#define ATHENA_SKELETAL_TRAPEZOIDATION_JOINT_H
...
public:
    struct BeadingPropagation
    {
        ...
        BeadingPropagation(const Beading &beading)
            : beading(beading), dist_to_bottom_source(0), dist_from_top_source(0), is_upward_propagated_only(false)
        {
        }
    };
    ...
    std::shared_ptr<BeadingPropagation> getBeading() { return beading.lock(); }
...
#endif // ATHENA_SKELETAL_TRAPEZOIDATION_JOINT_H
