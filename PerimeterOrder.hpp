...
#ifndef ATHENA_slic3r_GCode_PerimeterOrder_hpp_
#define ATHENA_slic3r_GCode_PerimeterOrder_hpp_
...
{
    explicit PerimeterExtrusion(const ExtrusionLine &extrusion, const double area, const Polygon &polygon,
                                const BoundingBox &bbox)
        : extrusion(extrusion), area(area), polygon(polygon), bbox(bbox)
    {
    }

    ExtrusionLine extrusion;
...
#endif // ATHENA_slic3r_GCode_Travels_hpp_
