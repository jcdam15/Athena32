...
#ifndef ATHENA_SKELETAL_TRAPEZOIDATION_GRAPH_H
#define ATHENA_SKELETAL_TRAPEZOIDATION_GRAPH_H
...
#include "libslic3r/Athena/utils/HalfEdge.hpp"
#include "libslic3r/Athena/utils/HalfEdgeNode.hpp"
...
class STHalfEdgeNode
    : public HalfEdgeNode<SkeletalTrapezoidationJoint, SkeletalTrapezoidationEdge, STHalfEdgeNode, STHalfEdge>
{
    using edge_t = STHalfEdge;
    using node_t = STHalfEdgeNode;
...
class SkeletalTrapezoidationGraph
    : public HalfEdgeGraph<SkeletalTrapezoidationJoint, SkeletalTrapezoidationEdge, STHalfEdgeNode, STHalfEdge>
{
    using edge_t = STHalfEdge;
    using node_t = STHalfEdgeNode;
