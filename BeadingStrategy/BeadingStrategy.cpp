...
BeadingStrategy::BeadingStrategy(coord_t bead_spacing, coord_t extrusion_width, double wall_split_middle_threshold,
...
BeadingStrategy::BeadingStrategy(const BeadingStrategy &other)
    : bead_spacing(other.bead_spacing)
    , extrusion_width(other.extrusion_width)
...
double BeadingStrategy::getAddMiddleThreshold() const
{
...
{
    return bead_spacing * bead_count;
}
