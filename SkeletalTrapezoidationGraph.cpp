...
void SkeletalTrapezoidationGraph::collapseSmallEdges(coord_t snap_dist)
{
    ...
    auto safelyRemoveEdge =
        [this, &edge_locator](edge_t *to_be_removed, Edges::iterator &current_edge_it, bool &edge_it_is_updated)
    {
    ...
    for (auto edge_it = edges.begin(); edge_it != edges.end();)
    {
        ...
        if (quad_mid && should_collapse(quad_mid->from, quad_mid->to))
        {
            ...
            int count = 0;
            for (edge_t *edge_from_3 = quad_end; edge_from_3 && edge_from_3 != quad_mid->twin;
                 edge_from_3 = edge_from_3->twin->next)
            {
...
void SkeletalTrapezoidationGraph::makeRib(edge_t *&prev_edge, const Point &start_source_point,
...
std::pair<SkeletalTrapezoidationGraph::edge_t *, SkeletalTrapezoidationGraph::edge_t *>
SkeletalTrapezoidationGraph::insertRib(edge_t &edge, node_t *mid_node)
{
...
SkeletalTrapezoidationGraph::edge_t *SkeletalTrapezoidationGraph::insertNode(edge_t *edge, Point mid,
